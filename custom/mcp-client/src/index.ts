...
export interface StdioConfig {
  ...
  /** Custom fork: expose the server's MCP resources as list/read tools (default true). */
  resources?: boolean
  /** Custom fork: expose the server's MCP prompts as list/get tools (default true). */
  prompts?: boolean
