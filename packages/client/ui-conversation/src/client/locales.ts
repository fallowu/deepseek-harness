...
export const zh = {
  ...
  'file.rejected.unsupported': '不支持的文件类型:{name}',
  'file.rejected.too-large': '文件过大(上限 20MB):{name}',
  'file.rejected.too-many-pages': 'PDF 页数超出上限(200 页):{name}',
  'file.rejected.too-long': '提取文本超出长度上限:{name}',
  'file.rejected.unreadable': '文件无法读取:{name}',
...
export const en = {
  ...
  'file.rejected.unsupported': 'Unsupported file type: {name}',
  'file.rejected.too-large': 'File too large (20MB limit): {name}',
  'file.rejected.too-many-pages': 'PDF exceeds the 200-page limit: {name}',
  'file.rejected.too-long': 'Extracted text exceeds the length limit: {name}',
  'file.rejected.unreadable': 'File could not be read: {name}',
