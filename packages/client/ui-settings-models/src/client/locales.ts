...
export const en = {
  ...
  reasoningInherit: 'Inherit catalog capability',
  reasoningOff: 'Non-reasoning model',
  reasoningCustom: 'Custom thinking levels',
  reasoningLevel: 'Level',
  reasoningWire: 'Wire value',
  reasoningWirePlaceholder: 'Value sent to the provider',
  reasoningNoLevels: 'Declare at least one thinking level beyond "off", or set the model to non-reasoning.',
  reasoningWireRequired: 'Every level except "off" needs the wire value the provider expects.',
  reasoningOffHint: '"off" may stay empty: the level is offered and nothing is sent.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelReasoning: '思考参数',
  reasoningInherit: '继承目录能力',
  reasoningOff: '不支持思考',
  reasoningCustom: '自定义思考级别',
  reasoningLevel: '级别',
  reasoningWire: '下发值',
  reasoningWirePlaceholder: '发送给提供方的值',
  reasoningNoLevels: '请至少声明一个 "off" 之外的思考级别，或将模型设为不支持思考。',
  reasoningWireRequired: '除 "off" 外的每个级别都需要填写提供方期望的下发值。',
  reasoningOffHint: '"off" 可留空：表示提供该级别且不发送任何值。',
  fetchModels: '获取可用模型',
  fetching: '正在询问提供方\u2026',
